  ...
  return (
    <div>
      <div className="jumbotron background">
        ...
        <p>
            This is the <strong>formbuilder</strong>, a tool to help
      ...
      <div className="container">
        ...
        <div className="col-md-4">
          ...
          <p>With this formbuilder you are not giving Google or any other giants your data.</p>                                                                                                                                                                                      
        ...
        <div className="col-md-4">
          <h3><i className="glyphicon glyphicon-heart-empty"></i> FROM</h3>
